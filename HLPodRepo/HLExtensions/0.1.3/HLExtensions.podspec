Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    core.source_files           = 'HLExtensions/Core/**/*'
    core.public_header_files    = 'HLExtensions/Core/**/*.h'
    core.dependency 'Aspects', '~> 1.4.1'
  end

  s.subspec 'Refresh' do |refresh|
    refresh.source_files        = 'HLExtensions/Refresh/**/*'
    refresh.public_header_files = 'HLExtensions/Refresh/**/*.h'
